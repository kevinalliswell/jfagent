...
| T-018 | P0 | In Progress | Add OpenAI-compatible real agent v1 | Backend chat should call an OpenAI-compatible `/v1/chat/completions` provider, accept `xingwan.store` via `OPENAI_BASE_URL`, and fall back cleanly when unavailable. |
